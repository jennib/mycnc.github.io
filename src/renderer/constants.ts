...
export const DEFAULT_GENERATOR_SETTINGS: GeneratorSettings = { // Ensure this matches the new interfaces
    ...
    bore: { centerX: 50, centerY: 50, holeDiameter: 20, holeDepth: -15, counterboreEnabled: true, cbDiameter: 30, cbDepth: -5, depthPerPass: 2, stepover: 40, feed: 400, plungeFeed: 150, spindle: 8000, safeZ: 5, toolId: null }, // Example values
