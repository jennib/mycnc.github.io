...
type CharacterStroke = LineSegment[];
type CharacterOutline = Point[][]; // Array of paths, each path is an array of points

interface Font {
  type: 'stroke' | 'outline';
  characters: {
    [key: string]: CharacterStroke | CharacterOutline;
  };
}

export const SANS_SERIF_STICK: Font = {
    type: 'stroke',
    characters: {
...
export const BLOCK_OUTLINE: Font = {
    type: 'outline',
    characters: {
...
export const SCRIPT: Font = { // THIS IS THE LINE I NEED TO CHANGE TO 'export const'
    type: 'stroke',
    characters: {
