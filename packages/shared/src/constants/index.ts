...
export const DEFAULT_GENERATOR_SETTINGS: GeneratorSettings = {
    ...
    mortisetenon: { partToGenerate: 'both', jointType: 'standard', width: 50, height: 20, depth: 10, tolerance: 0.1, feed: 800, plungeFeed: 200, spindle: 10000, safeZ: 5, depthPerPass: 3, toolId: null },
