...
export const DEFAULT_TOOLS: Tool[] = [
    { id: 1, name: '1/8" Flat Endmill', diameter: 3.175, type: 'endmill', flutes: 2, cutDirection: 'up' },
    { id: 2, name: '1/4" Flat Endmill', diameter: 6.35, type: 'endmill', flutes: 2, cutDirection: 'up' },
    { id: 3, name: '60 Degree V-Bit', diameter: 12.7, type: 'vbit60', flutes: 2, cutDirection: 'up' },
    { id: 4, name: '90 Degree V-Bit', diameter: 12.7, type: 'vbit90', flutes: 2, cutDirection: 'up' },
];
...
export const DEFAULT_SETTINGS: MachineSettings = {
    ...
    probe: { xOffset: 3.0, yOffset: 3.0, zOffset: 15.0, fastFeedRate: 100, slowFeedRate: 25, probeTravelDistance: 20, retractDistance: 2.0, blockWidthX: 20.0, blockWidthY: 20.0, blockHeight: 10.0, bitDiameter: 3.175 },
    scripts: {
...
export const DEFAULT_GENERATOR_SETTINGS: GeneratorSettings = {
    ...
    relief: { imageDataUrl: null, invert: false, width: 100, length: 100, maxDepth: -5, zSafe: 5, roughingEnabled: true, roughingToolId: null, roughingStepdown: 2, roughingStepover: 40, roughingStockToLeave: 0.5, roughingFeed: 800, roughingSpindle: 8000, finishingEnabled: true, finishingToolId: null, finishingStepover: 10, finishingAngle: 0, finishingFeed: 1000, finishingSpindle: 10000, operation: 'both', keepAspectRatio: true, gamma: 1.0, contrast: 1.0, smoothing: 0, detail: 0, quality: 'medium', colorAdjustmentEnabled: false, colorAdjustmentHigh: 255, colorAdjustmentLow: 0, colorAdjustmentMid: 128 },
    ...
    mortisetenon: { partToGenerate: 'both', jointType: 'standard', width: 50, height: 20, depth: 10, clearingWidth: 60, clearingLength: 30, tolerance: 0.1, feed: 800, plungeFeed: 200, spindle: 10000, safeZ: 5, depthPerPass: 3, toolId: null },
    ...
    halfLap: { partToGenerate: 'both', jointType: 'standard', width: 50, thickness: 15, lapLength: 50, feed: 800, plungeFeed: 200, spindle: 10000, safeZ: 5, depthPerPass: 3, toolId: null, gap: 0.2 },
    lockMitre: { stockThickness: 19, length: 100, bitDiameter: 6.35, bitAngle: 45, feedRate: 1000, stepover: 0.5, useSteppedVersion: true, stepdown: 1, toolId: null, partToGenerate: 'both' },
};
